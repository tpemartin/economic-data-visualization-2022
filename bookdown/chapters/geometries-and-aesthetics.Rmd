...
The result after **proper** revision:
...
### Graph output
  ...
  * Saving is tricky. You need to find the viewport ratio. (Different computers are different)
  
  * Given your graph width and height, you can save your output as:
